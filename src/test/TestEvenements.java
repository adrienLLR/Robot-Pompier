...
public class TestEvenements {
    ...
    private static void scenario2(Simulateur s){
        ...
        s.ajouteEvenement(new DeplaceRobot(s.getRobots()[1], Direction.EST, 2, s.getCarte()));
        s.ajouteEvenement(new DeplaceRobot(s.getRobots()[1], Direction.SUD, 3, s.getCarte()));
        s.ajouteEvenement(new DeplaceRobot(s.getRobots()[1], Direction.OUEST, 4, s.getCarte()));
