...
testProject:
	...
	java -classpath bin:bin/gui.jar test.TestChefPomp cartes/carteSujet.map
	java -classpath bin:bin/gui.jar test.TestChefPomp cartes/desertOfDeath-20x20.map
	java -classpath bin:bin/gui.jar test.TestChefPomp cartes/mushroomOfHell-20x20.map
	java -classpath bin:bin/gui.jar test.TestChefPomp cartes/spiralOfMadness-50x50.map

clean:
	rm -rf bin/*.class bin/environment bin/io bin/robot bin/simulation bin/test bin/evenementElementaire bin/evenemntAvances
